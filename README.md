...
[![Security: gosec](https://img.shields.io/badge/security-gosec-blue?style=flat&logo=security)](https://github.com/schlunsen/claude-control-terminal/actions/workflows/ci.yml)
